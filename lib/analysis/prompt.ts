...
- SIEMPRE 6: la lámina es una grilla de 3 por 2 y con menos queda un hueco. Con búsqueda, mezclá lo del sitio con lo de afuera (reseñas, posiciones, anuncios, seguidores): son la foto de lo que ya tiene en marcha. Si no llegás a 6, el sistema completa con números de los facts, pero elegidas por vos son mejores.
